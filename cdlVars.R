...
#####################################################################
#  1.0 -  This is a listing of CDL values and their associated titles
#####################################################################
...
#####################################################################
#  2.0 -  A set of lists of common, useful aggregations 
#####################################################################
...
#         return a list of labels from above
#####################################################################
cdl.updateNames <- function( y ) {
  return(
...
cdl.updateNames.data.frame <- function( x ) {
...
#####################################################################
#  4.0 -  This is the cropscape default projection 
#####################################################################
